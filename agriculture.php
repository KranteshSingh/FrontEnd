...
<!--Header end-->
    ...
    <!-- Hero Section-->
    <div class="container-fluid agriimage">
        <div class="row">
            <div class="col-md-6 justify-content-md-center">
                <h1 class="display-1 agritext ">Crop Cycles decisions backed by Data. Save 40% on
                    water, 20% on
                    insecticide and increase
                    production by 25%. Be a new generation farmer.</h1>
            </div>
            <div class="col-md-6 justify-content-md-center">
