...
<head>
    ...
    <meta name="description" content="Yuktix Case Study. The Client was storing raw produce red dry chili in cold storages across Telangana and Andhra Pradesh.">
    <!-- Favicon -->
        ...
        <div class="row align-items-lg-center">
            <div class="col-lg-5 mb-7 mb-lg-0">
                <div class="mb-4">
                    ...
                    <h1 class="text-primary">Produce Quality Monitoring</h1>
                ...
                <div class="col-lg-6 order-lg-2 align-self-lg-end">
                    ...
                    <div class="tab-content pr-lg-4">
                        <div class="tab-pane fade show active" id="pills-one-code-features-example2" role="tabpanel" aria-labelledby="pills-one-code-features-example2-tab">
                            <img class="avatar-img rounded-lg" src="assets\media\images\case-studies\2.png" alt="Image Description">
                        </div>
