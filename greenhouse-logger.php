                    ...
                    <ul class="step step-dashed mb-7">
                        ...
                        <li class="step-item mb-0">
                            <div class="step-content-wrapper">
                                ...
                                <div class="step-content">
                                    <h4>Relative Humidity Sensor</h4>
                                    <br>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="step-item mb-0">
                            <div class="step-content-wrapper">
                                ...
                                <div class="step-content">
                                    <h4>Soil Moisture and Temperature</h4>
                                    <br>
                                </div>
                            </div>
                        </li>
                        <li class="step-item mb-0">
                            <div class="step-content-wrapper">
                                <span class="step-icon step-icon-xs step-icon-soft-primary">5</span>
                                <div class="step-content">
                                    <h4>Soil EC Sensor</h4>
                                    <br>
                                </div>
                            </div>
                        </li>
                        <li class="step-item mb-0">
                            <div class="step-content-wrapper">
                                <span class="step-icon step-icon-xs step-icon-soft-primary">6</span>
                                <div class="step-content">
                                    <h4>CO2 Sensor</h4>
                                    <br>
                                </div>
        ...
        <div class="row justify-content-lg-between align-items-lg-center">
            <div class="col-lg-5 mb-9 mb-lg-0">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <p>Wireless, Solar powered Nodes with Battery</p>
                    </div>
                </div>
                <div class="media">
                    <span class="icon icon-xs icon-indigo icon-circle mt-1 mr-3">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <p>Easy to install, configure, operate and maintain.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
