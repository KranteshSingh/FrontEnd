...
<head>
    ...
    <title>Jhulsa for Muskmellon Farmers | Yuktix Case Study</title>
    <meta name="description" content="Yuktix Case Study Where We provided Yuktix GreenSense solution to the farmers on rental basis.">
    <!-- Favicon -->
        ...
        <div class="row align-items-lg-center">
            <div class="col-lg-5 mb-7 mb-lg-0">
                <div class="mb-4">
                    ...
                    <h1 class="text-primary">Jhulsa for Muskmellon Farmers</h1>
                ...
                <div class="col-lg-6 order-lg-2 align-self-lg-end">
                    ...
                    <div class="tab-content pr-lg-4">
                        <div class="tab-pane fade show active" id="pills-one-code-features-example2" role="tabpanel" aria-labelledby="pills-one-code-features-example2-tab">
                            <img class="avatar-img rounded-lg" src="assets\media\images\case-studies\6.png" alt="Image Description">
                        </div>
