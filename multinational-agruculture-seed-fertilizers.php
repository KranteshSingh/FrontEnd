...
<head>
    ...
    <meta name="description" content="The client is a Multinational company. One of their VRS (Vegetable Research Center) and seed production facility.">
    <!-- Favicon -->
    ...
    <div class="container space-2">
        <div class="row align-items-lg-center">
            <div class="col-lg-5 mb-7 mb-lg-0">
                <div class="mb-4">
                    <h1 class="text-primary">Multinational Seed & Fertilizers Company</h1>
                ...
                <div class="col-lg-6 order-lg-2 align-self-lg-end">
                    ...
                    <div class="tab-content pr-lg-4">
                        <div class="tab-pane fade show active" id="pills-one-code-features-example2" role="tabpanel" aria-labelledby="pills-one-code-features-example2-tab">
                            <img class="avatar-img rounded-lg" src="assets\media\images\case-studies\9.png" alt="Image Description">
                        </div>
