...
<head>
    ...
    <title>Privacy Policy | Yuktix</title>
...
<div class="bg-primary bg-img-hero" style="background-image: url(assets/svg/components/abstract-shapes-5.svg);">
  <div class="container space-2 space-lg-3">
    <div class="w-lg-65 text-center mx-lg-auto">
      <span class="badge badge-soft-light badge-pill font-size-1 py-3 px-4 mb-3">YUKTIX Technologies PVT. LTD.</span>
            ...
            <main class="col-md-12" role="main">
                ...
                <div class="mb-9">
                    ...
                    <ul class="text-secondary">
                        ...
                        <li>Flash Cookies. Certain features of our Service may use local stored objects (or Flash Cookies)
                            ...
                            For more information on how You can delete Flash Cookies, please read "Where can I change the
