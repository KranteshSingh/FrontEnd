...
<body>
    ...
    <div class="container space-2">
        ...
        <br>
        <div class="position-relative u-gradient-half-primary-v3">
            <div class="container u-space-2-top u-space-2-top--md u-space-2-top--lg u-space-2-bottom">
                ...
                <div class="row align-items-lg-center">
                    <div class="col-lg-5 mb-7 mb-lg-0">
                        <p class="lead font-weight-normal">
                            Plug multiple sensors into the device nodes. Multiple wireless options
                            available. On-board memory and processing.
                        </p>
                        <p class="lead font-weight-normal mb-7">
                            The ankiDB micro stack comprises of hardware nodes and routers and
                            firmware. The ankiDB micro provides hardware nodes for industrial and offgrid
                            sensor data capture.
                        </p>
