...
<body>
                                                ...
                                                <div class="navbar-banner"
                                                    ...
                                                    <div class="navbar-banner-content">
                                                        <div class="mb-4">
                                                            ...
                                                            <p class="text-white">Experience a level of our quality in
                                                                both design & customization works.</p>
                                                        </div>
                                                        ...
                                                        <a class="navbar-promo-link" href="#">
                                                            <div class="media align-items-center">
                                                                ...
                                                                <div class="media-body">
                                                                    ...
                                                                    <span class="navbar-promo-text">Learn On-demand
                                                                        demo</span>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    ...
                                                    <div class="navbar-promo-card navbar-promo-item">
                                                        <a class="navbar-promo-link" href="#">
                                                            <div class="media align-items-center">
                                                                ...
                                                                <div class="media-body">
                                                                    <span class="navbar-promo-title">App
                                                                        Marketplace</span>
                                                                    <span class="navbar-promo-text">Marketplace app
                                                                        demo</span>
                                                                </div>
                                                            </div>
                                                        </a>
                                                        ...
                                                        <a class="navbar-promo-link" href="#">
                                                            <div class="media align-items-center">
                                                                ...
                                                                <div class="media-body">
                                                                    ...
                                                                    <span class="navbar-promo-text">Help desk
                                                                        demo</span>
                                                                </div>
                                                            </div>
                                                        </a>
                                                ...
                                                <a class="d-block navbar-promo-inner" href="#">
                                                    <div class="position-relative">
                                                        <img class="img-fluid rounded mb-3"
                                                            src="../../assets/img/380x227/img1.jpg"
                                                            alt="Image Description">
                                                    </div>
                                                    <span class="navbar-promo-text font-size-1">Front makes you look at
                                                        things from a different perspectives.</span>
                                                </a>
                                            </div>
                                            <!-- End Promo -->
                                        </div>
                                    ...
                                    <div class="hs-mega-menu dropdown-menu" aria-labelledby="docsMegaMenu"
                                        ...
                                        <div class="navbar-promo-item">
                                            <a class="navbar-promo-link" href="#">
                                                <div class="media align-items-center">
                                                    <img class="navbar-promo-icon"
                                                        src="../../assets/svg/icons/icon-2.svg" alt="SVG">
                                                    <div class="media-body">
                                                        <span class="navbar-promo-title">
                                                            Documentation
                                                            <span
                                                                class="badge badge-primary badge-pill ml-1">v3.0</span>
                                                        </span>
                                        ...
                                        <div class="navbar-promo-item">
                                            <a class="navbar-promo-link" href="#">
                                                <div class="media align-items-center">
                                                    <img class="navbar-promo-icon"
                                                        src="../../assets/svg/icons/icon-1.svg" alt="SVG">
                                                    <div class="media-body">
    ...
    <br><br><br>
    <br><br><br>
    <H2 class="text-center">SCROLL TILL YOU REACH FOOTER</H2>
    <br><br><br>
    <br><br><br>
    <br><br><br>
    <br><br><br>
    <h1 class="text-center">LET ME KNOW IF THIS HEADER & FOOTER IS WORKING ON YOUR DEVICE</h1>
    <br><br><br>
    <br><br><br>
    <br><br><br>
    <br><br><br>
    ...
    <br><br><br>
    <br><br><br>
    <h2 class="text-center">See on the Right Bottom You'll see a Go To TOP Button</h2>
    <h2 class="text-center">Should I add this in rest of the pages?</h2>
    <br><br><br>
    <br><br><br>
    <br><br><br>
    <br><br><br>
